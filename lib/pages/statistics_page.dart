    ...
    try {
      switch (_tabController.index) {
        ...
        case 1: // 주간
          ...
          print('📅 주간 데이터 로드: ${startOfWeek.toString()} ~ ${endOfWeek.toString()}');
          _weeklyData = await _statisticsService.getWeeklyStats(startOfWeek);
          if (_weeklyData != null && _weeklyData!.isNotEmpty) {
            _weeklyAchievements = _weeklyData!.expand((stats) => stats.achievements).toList();
          }
          break;
        case 2: // 월간
          _monthlyData = await _statisticsService.getMonthlyStats(_selectedMonth);
          _monthlyAchievements = _monthlyData!.expand((stats) => stats.achievements).toList();
          break;
        case 3: // 연간
